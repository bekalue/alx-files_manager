...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Files Manager';
    const mailContent = [
      '<div>',
      '<h3>Hello {{ user.name }},</h3>',
      'Welcome to <a href="https://github.com/bekalue/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file managment API built with Node.js by ',
      '<a href="https://github.com/bekalue">Bekalu Geta</a>. ',
